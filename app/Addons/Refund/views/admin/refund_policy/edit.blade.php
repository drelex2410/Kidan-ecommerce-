...
@section('content')
    <div class="aiz-titlebar text-left mt-2 mb-3">
        <div class="row align-items-center">
            <div class="col-md-6">
                <h1 class="h3">{{ translate('Edit Refund Policy') }}</h1>
            </div>
    ...
    <form action="{{ route('admin.refund_policies.update', $refundPolicy->id) }}" method="POST">
        @csrf
        @method('PUT')
        <div class="row">
            <div class="col-lg-10 mx-auto">
                @include('addon:refund::admin.refund_policy._form', [
                    'submitLabel' => translate('Update Refund Policy'),
