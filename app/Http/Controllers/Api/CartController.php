...
class CartController extends Controller
{
    ...
    public function add(Request $request)
    {
        ...
        $product = [
            ...
            'regular_price' => (float) variation_price($product_variation->product, $product_variation, false),
            'dicounted_price' => (float) variation_discounted_price($product_variation->product, $product_variation, false),
