...
class CartItemResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'thumbnail' => $thumbnail,
            'regular_price' => (float) variation_price($this->product, $this->variation, false),
            'dicounted_price' => (float) variation_discounted_price($this->product, $this->variation, false),
