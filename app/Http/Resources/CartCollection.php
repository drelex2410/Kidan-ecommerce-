        ...
        return [
            'data' => $this->collection->map(function($data) {
                return [
                    ...
                    'regular_price' => (double) variation_price($data->product,$data->variation, false),
                    'dicounted_price' => (double) variation_discounted_price($data->product,$data->variation, false),
