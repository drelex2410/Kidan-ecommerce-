...
{   
    ...
    public function toArray($request)
    {
        return [
            ...
            'base_price' => (double) product_base_price($this, false),
            'highest_price' => (double) product_highest_price($this, false),
            'base_discounted_price' => (double) product_discounted_base_price($this, false),
            'highest_discounted_price' => (double) product_discounted_highest_price($this, false),
            ...
            'shop' => [
                ...
                'logo' => api_asset(optional($this->shop)->logo),
                'rating' => (double) optional($this->shop)->rating,
