import{o as i,j as o,k as e,F as c,q as d,z as u,t as p,m as h,y as m,v as g,T as y,A as f,B as b}from"./app-619fdeae.js";import{_ as w}from"./_plugin-vue_export-helper-c27b6911.js";const v={name:"FAQPage",data(){return{activeFaq:null,faqs:[{question:"What is KIDANSTORE?",answer:"KIDANSTORE is a contemporary African lifestyle and fashion ecosystem offering curated fashion, beauty, home essentials, and luxury lifestyle products. We combine culture, craftsmanship, and modern living to deliver a refined shopping experience."},{question:"Where is KIDANSTORE based?",answer:"We are based across Africa with growing physical touchpoints, delivery partners, and pop-up experiences in key cities."},{question:"How do I place an order?",answer:"Simply browse our collections, add items to your cart, and checkout using your preferred payment option. You will receive an order confirmation immediately after purchase."},{question:"What payment methods do you accept?",answer:`We accept:
            ...
            Website: <strong>www.kidanstore.com</strong>`}]}},methods:{toggleFaq(s){this.activeFaq=this.activeFaq===s?null:s}}},a=s=>(f("data-v-d2f50e0b"),s=s(),b(),s),_={class:"faq-page"},k=a(()=>e("div",{class:"page-header text-center mb-10"},[e("h1",{class:"text-h3 font-weight-bold mb-2"},"Frequently Asked Questions"),e("p",{class:"text-subtitle-1",style:{color:"#666"}},"You have questions? we have answers.")],-1)),q={class:"faq-content"},I=["onClick","aria-expanded"],A=a(()=>e("span",{class:"question-icon"},"Q",-1)),D={class:"question-text"},N=a(()=>e("svg",{width:"20",height:"20",viewBox:"0 0 20 20",fill:"none"},[e("path",{d:"M5 7.5L10 12.5L15 7.5",stroke:"currentColor","stroke-width":"2","stroke-linecap":"round","stroke-linejoin":"round"})],-1)),K=[N],T={key:0,class:"faq-answer"},F=["innerHTML"];function x(s,C,S,W,r,l){return i(),o("div",_,[k,e("div",q,[(i(!0),o(c,null,d(r.faqs,(n,t)=>(i(),o("div",{key:t,class:"faq-item mb-4"},[e("button",{class:"faq-question",onClick:P=>l.toggleFaq(t),"aria-expanded":r.activeFaq===t},[A,e("span",D,u(n.question),1),e("span",{class:p(["toggle-icon",{active:r.activeFaq===t}])},K,2)],8,I),h(y,{name:"fade-slide"},{default:m(()=>[r.activeFaq===t?(i(),o("div",T,[e("div",{innerHTML:n.answer},null,8,F)])):g("",!0)]),_:2},1024)]))),128))])])}const j=w(v,[["render",x],["__scopeId","data-v-d2f50e0b"]]);export{j as default};
