<template>
<footer class="pt-8 text-white pb-14 pb-md-10 pb-lg-0" style="background-color: #3d2222;">
...
<style scoped>
/* Header + newsletter title color */
footer h4.primary-text,
footer .primary-text.fs-14.fw-700 {
  color: #b8a688 !important;
}

/* Force Subscribe button to use accent color */
footer .v-btn.v-btn--variant-outlined {
  border-color: #b8a688 !important;
  color: #b8a688 !important;
}

/* On hover and active */
footer .v-btn.v-btn--variant-outlined:hover,
footer .v-btn.v-btn--variant-outlined:active {
  background-color: #b8a688 !important;
  color: #3d2222 !important; /* dark footer background contrast */
}
</style>
