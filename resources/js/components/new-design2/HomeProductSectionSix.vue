      ...
      <div class="content-wrapper">
        <div class="promo-banner">
          ...
          <div v-else class="banner-content">
            ...
            <h2 class="banner-title">Limited Time Offer</h2>
            <p class="banner-description">
              Don't miss out on these exclusive deals.<br />
              Shop now before they're gone forever.
            </p>
            <dynamic-link :to="banner.link" append-class="discover-btn-wrapper">
              <button class="discover-btn">SHOP NOW</button>
            </dynamic-link>
          </div>
        </div>
...
export default {
  ...
  async created() {
    try {
      const res = await this.call_api("get", "setting/home/product_section_six");
      if (res.data.success) {
...
/* Additional responsive styles for section header */
@media (max-width: 960px) {
  .section-header {
    margin-bottom: 2rem;
  }
