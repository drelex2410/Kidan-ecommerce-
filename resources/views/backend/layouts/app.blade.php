...
<body class="">
    ...
    <script type="text/javascript">
        ...
        // The storefront PWA registers a root-scoped service worker. Unregister it
        // on backend pages so admin navigation is never handled by stale cached logic.
        ...
        if (window.caches && window.location.pathname.indexOf('/admin') === 0) {
