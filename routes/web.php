...
Route::get('/category/{slug}', SpaController::class)->name('products.category');
Route::get('/todays-deal', SpaController::class)->name('todays-deal');

Route::get('/blog-details/{slug}', SpaController::class)->name('blog.details');
...
Route::get('{slug}', SpaController::class)->where('slug', '.*');
